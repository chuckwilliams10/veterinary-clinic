...
$(function() {		
	...
	$('form').floodling('lab_code', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_name', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_sequence', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_unit', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_normal_value', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_normal_value_start', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_normal_value_end', "<?php echo addslashes($laboratory_test->pet_id); ?>");		
	$('form').floodling('lab_status', "<?php echo addslashes($laboratory_test->pet_id); ?>");
});
</script>
