...
$(function() {		
	$('form').floodling('spe_id', "<?php echo addslashes($breed->spe_name); ?>");		
	$('form').floodling('bre_name', "<?php echo addslashes($breed->bre_name); ?>");		
	$('form').floodling('bre_other_names', "<?php echo addslashes($breed->bre_other_names); ?>");
});
</script>
