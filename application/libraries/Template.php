...
EOT;
	...
	private function bootstrap()
	{
		$resources_url = res_url();
		return <<<EOT
		<link rel="stylesheet" type="text/css" href="{$resources_url}mythos/boomerang-styles/css/boomerang.css" />
		<script type="text/javascript" src="{$resources_url}mythos/boomerang-styles/js/boomerang.js"></script>
EOT;
	}
